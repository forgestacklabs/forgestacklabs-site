      ...
      <section className="relative py-16 px-6 pb-32">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <Subsection title="1. Information We Collect" delay={0.1}>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Country</li>
                <li>Project requirements and message content</li>
              </ul>
            </Subsection>

            <Subsection title="2. How We Use Your Information" delay={0.15}>
              <p>We use the information you provide to:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Respond to your inquiries and project requests</li>
                <li>Communicate with you about potential projects</li>
                <li>Improve our services and website experience</li>
                <li>Send relevant updates about your project (with consent)</li>
              </ul>
            </Subsection>

            <Subsection title="3. Data Storage & Security" delay={0.2}>
              <p>
                Your information is stored securely using industry-standard encryption. We use trusted 
                third-party services (such as Notion) for managing client communications. We do not sell, 
                trade, or otherwise transfer your personal information to outside parties.
              </p>
            </Subsection>

            <Subsection title="4. Cookies" delay={0.25}>
              <p>
            ...
            <Subsection title="5. Your Rights" delay={0.3}>
            ...
            <Subsection title="6. Contact Us" delay={0.35}>
